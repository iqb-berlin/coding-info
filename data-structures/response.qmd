...
|`DERIVE_ERROR`|Dieser Status zeigt an, dass eine Ableitung fehlgeschlagen ist. Dies bezieht sich nicht darauf, dass zumindest eine die zugrundeliegenden Variablen einen unzureichenden Status hat, sondern auf einen technischen Fehler beim Ableitungsprozess. Dies kann sich beispielsweise auf einen Typkonflikt (numerisch, Text) beziehen und ist in den meisten Fällen über eine Anpassung des Kodierschemas korrigierbar.|
...
| Alle Variablen haben den Status `PARTLY_DISPLAYED` | `PARTLY_DISPLAYED`|
