...
* Wird im Value ein Objekt `application/octet-stream;base64` erkannt, kann es als separate Datei gespeichert werden (z. B. GeoGebra).
...
* Entfernen aller Variablen, die in jedem Vorkommen denselben Wert haben
* Entfernen des Status-Wertes und ersetzen ggf. durch einen Missing-Wert
